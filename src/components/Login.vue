      ...
      <div class="card">
        ...
        <form>
          <div class="input-container">
            <input type="text" id="input_username" required="required" name="username" v-model="username"
          ...
          <div class="input-container">
            <input type="password" id="input_password" required="required" name="password" v-model="password"
                   autocomplete="new-password"/>
